  ...
  return (
    <div>
      <div className="card border-0 shadow-sm d-flex flex-lg-column flex-md-row align-items-lg-start align-items-md-start p-2 p-lg-2 p-xxl-3 p-md-3 mb-2 rounded-3">
          <div className="d-flex p-0 flex-lg-column flex-column align-items-center align-items-sm-center">
            <div className="d-flex align-items-center gap-4 align-items-sm-center gap-lg-4 gap-md-2 flex-lg-row flex-md-column">
              <div className="icon mt-md-1">
                <img src={personIcon} style={{width:"18.545px", height:"18.545px"}} alt=" - "/>
              </div>
              <div>
          ...
          <div className="d-flex flex-column flex-lg-column align-items-center p-0 gap-3 gap-lg-3 gap-md-5 flex-md-row mt-md-4 mx-md-4 mx-lg-0 mt-lg-3 mt-2">
            <div className="d-flex p-lg-0 align-items-center gap-5 align-items-lg-start">
